		...
		t_cy_info *inter)
{
	...
	if (-h / 2 <= outer_intersection.p_c_n && outer_intersection.p_c_n <= h / 2
		&& outer_intersection.t > 0)
	{
	...
	else if (-h / 2 <= inner_intersection.p_c_n && inner_intersection.p_c_n <= h
			/ 2 && inner_intersection.t > 0)
	{
